...
// Copyright (c) 2014 The ExaByte developers
...
const string strMessageMagic = "ExaByte Signed Message:\n";
...
static const int64 nTargetTimespan = 30; // 30 sec (NUM_ALGOS * 30 seconds) readjusts difficulty
static const int64 nTargetSpacing = 30; // 30 sec (NUM_ALGOS * 30 seconds) between blocks
static const int64 nInterval = 1; // retargets every blocks

static const int64 nAveragingInterval = 10; // 
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ExaByteMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ExaByteMiner : ProcessBlock, block not accepted");
    }
...
void static ThreadBitcoinMiner(CWallet *pwallet)
{
    ...
    {
        printf("ExaByte miner terminated\n");
        throw;
    }
}
